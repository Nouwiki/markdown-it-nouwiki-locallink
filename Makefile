...
browserify:
	...
	( printf "/*! ${NPM_PACKAGE} ${NPM_VERSION} ${GITHUB_PROJ} @license MIT */" ; \
		...
		) > dist/markdown-it-nouwiki-locallink.js
	# Minify
	./node_modules/.bin/uglifyjs dist/markdown-it-nouwiki-locallink.js -b beautify=false,ascii-only=true -c -m \
		--preamble "/*! ${NPM_PACKAGE} ${NPM_VERSION} ${GITHUB_PROJ} @license MIT */" \
		> dist/markdown-it-nouwiki-locallink.min.js
